...
class OptionsScanner:
    def __init__(self):
        ...
        self.output_file = f"scan_results_{self.timestamp}.csv"
    ...
    def load_sp500_symbols(self):
        ...
        try:
            ...
            print(f"Error loading S&P 500 symbols: {str(e)}")
            return []
...
def main():
    ...
    print("Options Scanner Menu:")
    print("1. Scan S&P 500 stocks")
    ...
    if choice == '1':
        symbols = scanner.load_sp500_symbols()
        if not symbols:
            print("Failed to load S&P 500 symbols. Please try another option.")
            return
    elif choice == '2':
        ...
        symbols_input = input("Enter symbols separated by commas (e.g., AAPL,MSFT,GOOGL): ")
